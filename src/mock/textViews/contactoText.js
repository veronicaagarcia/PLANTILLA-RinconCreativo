// Todo contenido personalizable/reemplazable. Desde el nombre en la pestalla del navedagor, como h1-h6, textos, etc de la VISTA CONTACTO
export const contactoText = {
    metaTitle: "Hermes | CONTACTO",
    ...
    Subtitle1: "¿Listo para transformar tu marca?",
    text1:"Estamos aquí para ayudarte a darle vida a tu proyecto. Completa el formulario a continuación, y uno de nuestros expertos se pondrá en contacto contigo pronto.",
    Subtitle2: "Información de contacto directo",
    WhatsApp:"WhatsApp",
    redsocial:"@hermes"
}