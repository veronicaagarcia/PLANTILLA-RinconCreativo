...
const proyectosText = {
    ...
    Subtitle1: "Conoce alguno de nuestros Trabajos destacados",
    ...
    text2:"Nuestro compromiso va más allá de la entrega de cada proyecto. En Rincón Creativo, continuamos acompañando a nuestros clientes en cada paso de su evolución, asegurándonos de que cada estrategia, diseño y desarrollo cumpla con los objetivos planteados y siga siendo relevante en un mercado en constante cambio. Nos apasiona hacer que cada idea cobre vida y logre resultados tangibles. Si tienes una visión para tu negocio, estamos aquí para ayudarte a hacerla realidad."
